...
(function initMarketingCookies() {
  ...
  if (shouldOverwrite(utm_data, current_utm_data)) {
    ...
    // Max 400 days
    document.cookie = `utm_data=${utm_data_cookie}; expires=Tue, 19 Jan 9999 03:14:07 UTC;  path=/; SameSite=None; Secure;`;
  }
  ...
  if (isAffiliateTokenExist) {
    ...
    document.cookie = `affiliate_tracking=${affiliateToken}; expires=Tue, 19 Jan 9999 03:14:07 UTC; path=/; SameSite=None; Secure;`;
  }
  /* start handling affiliate tracking */
  if (searchParams.has("sidc")) {
    ...
    document.cookie = `affiliate_tracking=${searchParams.get(
      "sidc"
    )}; expires=Tue, 19 Jan 9999 03:14:07 UTC;  path=/; SameSite=None; Secure;`;
  }
  ...
  if (!signup_device_cookie.signup_device) {
    ...
    document.cookie = `signup_device=${signup_data_cookie}; path=/; SameSite=None; Secure;`;
  }
  ...
  if (!date_first_contact_cookie.date_first_contact) {
    ...
    ws.onmessage = function (msg) {
      ...
      document.cookie = `date_first_contact=${date_first_contact_data_cookie}; path=/; SameSite=None; Secure;`;
